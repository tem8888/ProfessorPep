            ...
            await UserModel.findOneAndUpdate({idUser: message.author.id},
                {
                    ...
                    $inc : {points_tour: addPoints, answersCount: 1}
                },{ new: true, upsert: true })
            .then( (user) => {
                message.channel.send(`**${user.name}**${congrat.noHint[`${randCongrat}`]} заработано **${addPoints} баллов**! Всего: ${user.points_tour}`);
            })
            break;
        case 1:
            ...
            .then((user)=>{
                message.channel.send(`**${user.name}**${congrat.hint1[`${randCongrat}`]} получено **${addPoints} балл(-а,-ов)**! Всего: ${user.points_tour}`);
            })  
             break;
        case 2:
            ...
            .then((user)=>{
                message.channel.send(`**${user.name}**${congrat.hint2[`${randCongrat}`]} получено **${addPoints} балл(-а,-ов)**! Всего: ${user.points_tour}`);
            });
            break;
        case 3:
            ...
            .then((user)=>{
                message.channel.send(`**${user.name}**${congrat.hint3[`${randCongrat}`]} **+${addPoints} балл(-а,-ов)**! Всего: ${user._tour}`);
            });
            break;
        case 4:
            ...
            .then((user)=>{
                message.channel.send(`**${user.name}**${congrat.hint4[`${randCongrat}`]} **+${addPoints} балл(-а,-ов)**! Всего: ${user.points_tour}`);
             });
             break;
        case 5:
            ...
            .then((user)=>{
                message.channel.send(`**${user.name}**${congrat.hint5[`${randCongrat}`]} **+${addPoints} балл(-а)**! Всего: ${user.points_tour}\n\nВыбираю новый вопрос...`);
            });
             break;
        case 6:
            ...
            .then((user)=>{
                message.channel.send(`**${user.name}**${congrat.hint6[`${randCongrat}`]} **+${addPoints} балл(-а)**! Всего: ${user.points_tour}\n\nВыбираю новый вопрос...`);
            });
             break;
        default:
            addPoints = 1;
